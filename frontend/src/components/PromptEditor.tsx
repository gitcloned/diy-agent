...
- Assist with writing and editing tasks`,
  ...
  },
  {
    ...
    name: "Code Assistant",
    description:
      "Assistant specialized in programming and software development",
...
- Report writing and documentation`,
  ...
  },
  {
    ...
    description:
      "Assistant for creative writing, storytelling, and content creation",
    category: "Creative",
...
- Maintain the author's original intent`,
  ...
  },
  {
    ...
    description:
      "Assistant for creating clear, comprehensive technical documentation",
